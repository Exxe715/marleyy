...
exports.run = async (client, message, args) => {
  ...
  const marley = `https://flamingtext.com/net-fu/proxy_form.cgi?imageoutput=true&script=orlando-logo&text=${yazi}`
  .replace(' ', '+')
...
exports.help = {
    name: 'rainbow',
    description: 'Changes your text to a rainbow logo.',
    usage: 'rainbow'
}