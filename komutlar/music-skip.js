...
.setDescription(`<a:tac:833436703703302164>  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setTitle("• Hata: 001 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:tac:833436703703302164>  **| Şu anda hiçbir müzik çalmamaktadır!**`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());    
...
.setColor(AloneDogru) 
.setTitle("Marley | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:tac:833436703703302164> **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
